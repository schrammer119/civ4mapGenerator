...
Use [run_planetsim.py](../../tests/run_planetsim.py) as an end-to-end diagnostic run, not a unit test. It prints generation, terrain, climate, river, feature, and resource statistics.
